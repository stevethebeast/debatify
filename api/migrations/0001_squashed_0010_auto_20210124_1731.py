# Generated by Django 3.1.2 on 2021-01-24 16:53
...
# api.migrations.0002_CategoryLoad

class Migration(migrations.Migration):

    replaces = [('api', '0001_initial'), ('api', '0002_CategoryLoad'), ('api', '0003_user_mail_confirmed'), ('api', '0004_chatcomment'), ('api', '0005_chatcomment_contact_name'), ('api', '0006_debate_activity_score'), ('api', '0007_auto_20210109_1624'), ('api', '0008_auto_20210115_1113'), ('api', '0009_recentchatcomments'), ('api', '0010_auto_20210124_1731')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('SCORE', models.IntegerField(default=0)),
                ('CREATED_AT', models.DateTimeField(auto_now_add=True)),
                ('ARGUMENT_ID', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='api.argument')),
                ('CONTACT_ID', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CREATED_AT', models.DateTimeField(auto_now_add=True)),
                ('CREATOR_ID', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='argument',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CREATED_AT', models.DateTimeField(auto_now_add=True)),
                ('CONTACT_ID', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('COUNTER_ARGUMENT_ID', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='api.counter_argument')),
            ],
            options={
        ...
        #migrations.RunPython(
         #   code=api.migrations.0002_CategoryLoad.load_categories,
        #),
        migrations.AddField(
            model_name='debate',
            name='CATEGORY_ID',
